...
class OwnerCategoryTable extends Component{
    ...
    componentDidMount(){
        fetch(`/meals/restaurant/${this.props.namerestaurant}`)
        .then(data=>data.json())
    ...
    render(){
        ...
        if(!this.state.adding && !this.state.editing){
            ...
            return(
                <MealForm add={this.add} namerestaurant={this.props.namerestaurant} ></MealForm>
            ...
            return(
                <EditMealForm edit={this.edit} idMeal={this.state.selectedMeal}  namerestaurant={this.props.namerestaurant}></EditMealForm>
            );
        }
        else{
            return(
